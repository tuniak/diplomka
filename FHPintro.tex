...
However, using this rescaled time, and setting density to be constant ($\rho = \rho_0$) for all terms except the pressure \ref{press}), we get the familiar incompressible Euler equation
\begin{equation}
