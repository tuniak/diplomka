\chapter{FHP}
Again, his improved lattice gas cellular automaton is named after its inventors -- Frisch, Humpfrey and Pomeu. 
...
The whole improvement of FHP is one simple change - instead of square grid, FHP builds on a hexagonal grid. 
...
All other properties are implied by the increased symmetry of the hexagonal grid.
